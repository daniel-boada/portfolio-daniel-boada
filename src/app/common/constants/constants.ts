    ...
    experiencesInfo: CardInfo[] = [
        {
            ...
            technologies: ['Angular', 'HTML', 'SCSS', 'JSP', 'jQuery', 'JS']
        },
        {
            ...
            technologies: ['Angular', 'HTML', 'SCSS', 'nodeJS', 'karma', 'Jasmine']
        },
        {
    ...
    projectsInfo: CardInfo[] = [
        {
            title: 'Technical Lead',
            description:
                'Designed a website for a small family owned cleaning business. The client requested a clean modern look and a way to modify make changes to the website after it was built',
